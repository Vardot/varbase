[![Build Status](https://travis-ci.org/Vardot/varbase.svg?branch=8.x-4.15)](https://travis-ci.org/Vardot/varbase/builds/344801999) Varbase 8.4.15
...
```
composer create-project Vardot/varbase-project:^8.4.15 PROJECT_DIR_NAME --no-interaction
```
