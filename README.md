[![Build Status](https://travis-ci.org/Vardot/varbase.svg?branch=8.x-4.27)](https://travis-ci.org/Vardot/varbase/builds/449236609) Varbase 8.4.27
...
```
composer create-project Vardot/varbase-project:8.4.27 PROJECT_DIR_NAME --no-interaction
```
