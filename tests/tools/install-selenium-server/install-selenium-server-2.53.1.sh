...
if [ ! -d "/usr/lib/selenium" ]; then
  ...
  sudo wget http://selenium-release.storage.googleapis.com/3.9/selenium-server-standalone-3.9.1.jar
  sudo mv selenium-server-standalone-3.9.1.jar /usr/lib/selenium/selenium-server-standalone-3.9.1.jar
  sudo ln -s /usr/lib/selenium/selenium-server-standalone-3.9.1.jar /usr/lib/selenium/selenium-server-standalone.jar
