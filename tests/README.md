...
To test varbase 10.1.x in the right way you will need to build varbase using
the composer.

## Create a Varbase project with [Composer](https://getcomposer.org/download/):

```
composer create-project vardot/varbase:10.1.x-dev PROJECT_DIR_NAME --stability dev --no-interaction
```
...
composer require --dev drush/drush:~12.0
