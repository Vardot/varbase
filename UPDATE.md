...
#  For Example:
* https://www.drupal.org/project/varbase/releases/8.x-4.28
* https://www.drupal.org/project/varbase/releases/8.x-4.27
* https://www.drupal.org/project/varbase/releases/8.x-4.26
...
# Updating Varbase 8.4.27 to Varbase 8.4.28
...
```
  Given that we are at the root folder for varbase project, not the docroot
   ...
   When we delete the "vendor" folder
    ...
    And we run the "composer require vardot/varbase:8.4.28" command
...
## Updating the active config and database from Varbase 8.4.27 to Varbase 8.4.28
```
...
# Updating Varbase 8.4.26 to Varbase 8.4.27
  If you already did the update of Varbase from 8.4.25 to 8.4.26, this
  updating to 8.4.27 will be a quick and easy one.


## Updating files with Copy and Paste for Varbase 8.4.26 to Varbase 8.4.27
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
...
```
  Given that we are at the root folder for varbase project, not the docroot
   ...
   When we delete the "vendor" folder
    And we delete the "composer.lock" file
    And we run the "composer require vardot/varbase:8.4.27" command
    And wait for composer to finish work
   Then we should not see any issues in the terminal
    And we should see "Writing lock file" in the terminal
    And we should see "Generating autoload files" in the terminal
...
## Updating the active config and database from Varbase 8.4.26 to Varbase 8.4.27
```
  Given that we are in the docroot of the current Varbase project
    And all files are updated using (copy and past) or (composer require/update
   When we run drush "updb" or go to "/update.php"
...
# Updating Varbase 8.4.25 to Varbase 8.4.26
  If you already did the update of Varbase from 8.4.24 to 8.4.25, this
  updating to 8.4.26 will be a quick and easy one.


## Updating files with Copy and Paste for Varbase 8.4.25 to Varbase 8.4.26
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
...
```
  Given that we are at the root folder for varbase project, not the docroot
   ...
   When we delete the "vendor" folder
    And we delete the "composer.lock" file
    And we run the "composer require vardot/varbase:8.4.26" command
    And wait for composer to finish work
   Then we should not see any issues in the terminal
    And we should see "Writing lock file" in the terminal
    And we should see "Generating autoload files" in the terminal
...
## Updating the active config and database from Varbase 8.4.25 to Varbase 8.4.26
```
  Given that we are in the docroot of the current Varbase project
    And all files are updated using (copy and past) or (composer require/update
   When we run drush "updb" or go to "/update.php"
   Then we should see the steps of updates.
   When we run drush "updb" or go to "/update.php" again
   Then we will have the site update with the new Varbase 8.4.26 version
   When we go to "/admin/config/development/features"
   Then we should see "Changed"
   When we follow with each feature to import new changes.
   Then we will have the Varbase site updated to the latest version.
...
# Updating Varbase 8.4.23 to Varbase 8.4.24
  ...
  updating to 8.4.23 will be a quick and easy one.


## Updating files with Copy and Paste for Varbase 8.4.23 to Varbase 8.4.24
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
...
## Updating the active config and database from Varbase 8.4.23 to Varbase 8.4.24
```
  Given that we are in the docroot of the current Varbase project
    And all files are updated using (copy and past) or (composer require/update
   When we run drush "updb" or go to "/update.php"
   Then we should see the steps of updates.
   When we run drush "updb" or go to "/update.php" again
   Then we will have the site update with the new Varbase 8.4.24 version
   When we go to "/admin/config/development/features"
   Then we should see "Changed"
   When we follow with each feature to import new changes.
   Then we will have the Varbase site updated to the latest version.
...
# Updating Varbase 8.4.19 to Varbase 8.4.20
## Same as updating Varbase 8.4.18 to Varbase 8.4.19
...
```
  Given that we are at the root folder for varbase project, not the docroot
   ...
   When we delete the "vendor" folder
    And we delete the "composer.lock" file
    And we run the "composer require vardot/varbase:8.4.17" command
    And wait for composer to finish work
   Then we should not see any issues in the terminal
    And we should see "Writing lock file" in the terminal
    And we should see "Generating autoload files" in the terminal
...
## Updating the active config and database from Varbase 8.4.16 to Varbase 8.4.17
```
  Given that we are in the docroot of the current Varbase project
    And all files are updated using (copy and past) or (composer require/update
   When we run drush "updb" or go to "/update.php"
   Then we should see the steps of updates.
   When we run drush "updb" or go to "/update.php" again
   Then we will have the site update with the new Varbase 8.4.17 version
   When we go to "/admin/config/development/features"
   Then we should see "Changed"
   When we follow with each feature to import new changes.
   Then we will have the Varbase site updated to the latest version.
...
# Updating Varbase 8.4.15 to Varbase 8.4.16
  If you already did the update of Varbase from 8.4.15 to 8.4.16, this
  updating to 8.4.16 will be a quick and easy one.
...
## Updating files with Copy and Paste for Varbase 8.4.13 to Varbase 8.4.14
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
...
## Updating files with Copy and Paste for Varbase 8.4.12 to Varbase 8.4.13
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
