...
#  For Example:
* https://www.drupal.org/project/varbase/releases/8.x-5.5
* https://www.drupal.org/project/varbase/releases/8.x-5.4
* https://www.drupal.org/project/varbase/releases/8.x-5.3
...
# Updating Varbase 8.5.4 to Varbase 8.5.5
If you already did the update of Varbase from 8.5.3 to 8.5.4, this updating
 to 8.5.5 will be a quick and easy one.

## Updating files with *Copy and Paste* for Varbase 8.5.4 to Varbase 8.5.5
```
...
```
  Given that we are at the root folder for varbase project, not the docroot
   ...
   When we delete the "composer.lock" file
    ...
    And we run the "composer require vardot/varbase:8.5.5" command
...
## Updating the active config and database from Varbase 8.5.4 to Varbase 8.5.5
```
  Given that we are in the docroot of the current Varbase project
   ...
   Then we will have the site update with the new Varbase 8.5.5 version
...
# Updating Varbase 8.5.3 to Varbase 8.5.4
If you already did the update of Varbase from 8.5.2 to 8.5.3, this updating
 to 8.5.4 will be a quick and easy one.

## Updating files with *Copy and Paste* for Varbase 8.5.3 to Varbase 8.5.4
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
...
```
  Given that we are at the root folder for varbase project, not the docroot
   ...
   When we delete the "composer.lock" file
    ...
    And we delete the "docroot/profiles/varbase" folder
    And we delete the "docroot/libraries" folder
    And we run the "composer require vardot/varbase:8.5.4" command
    And wait for composer to finish work
   Then we should not see any issues in the terminal
    And we should see "Writing lock file" in the terminal
    And we should see "Generating autoload files" in the terminal
...
## Updating the active config and database from Varbase 8.5.3 to Varbase 8.5.4
```
  Given that we are in the docroot of the current Varbase project
    And all files are updated using (copy and past) or (composer require/update
   When we run drush "updb" or go to "/update.php"
   Then we should see the steps of updates.
   When we run drush "updb" or go to "/update.php" again
   Then we will have the site update with the new Varbase 8.5.4 version
   When we go to "/admin/config/development/features"
   Then we should see "Changed"
   When we follow with each feature to import new changes.
   Then we will have the Varbase site updated to the latest version.
...
# Updating Varbase 8.5.2 to Varbase 8.5.3
If you already did the update of Varbase from 8.5.1 to 8.5.2, this updating
 to 8.5.3 will be a quick and easy one.

## Updating files with *Copy and Paste* for Varbase 8.5.2 to Varbase 8.5.3
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
...
```
  Given that we are at the root folder for varbase project, not the docroot
   ...
   When we delete the "composer.lock" file
    ...
    And we delete the "docroot/profiles/varbase" folder
    And we delete the "docroot/libraries" folder
    And we run the "composer require vardot/varbase:8.5.3" command
    And wait for composer to finish work
   Then we should not see any issues in the terminal
    And we should see "Writing lock file" in the terminal
    And we should see "Generating autoload files" in the terminal
...
## Updating the active config and database from Varbase 8.5.2 to Varbase 8.5.3
```
  Given that we are in the docroot of the current Varbase project
    And all files are updated using (copy and past) or (composer require/update
   When we run drush "updb" or go to "/update.php"
   Then we should see the steps of updates.
   When we run drush "updb" or go to "/update.php" again
   Then we will have the site update with the new Varbase 8.5.2 version
   When we go to "/admin/config/development/features"
   Then we should see "Changed"
   When we follow with each feature to import new changes.
   Then we will have the Varbase site updated to the latest version.
...
# Updating Varbase 8.5.1 to Varbase 8.5.2
If you already did the update of Varbase from 8.5.0 to 8.5.1, this updating
 to 8.5.2 will be a quick and easy one.

## Updating files with *Copy and Paste* for Varbase 8.5.1 to Varbase 8.5.2
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
...
```
  Given that we are at the root folder for varbase project, not the docroot
   ...
   When we delete the "composer.lock" file
    ...
    And we delete the "docroot/profiles/varbase" folder
    And we delete the "docroot/libraries" folder
    And we run the "composer require vardot/varbase:8.5.2" command
    And wait for composer to finish work
   Then we should not see any issues in the terminal
    And we should see "Writing lock file" in the terminal
    And we should see "Generating autoload files" in the terminal
...
## Updating the active config and database from Varbase 8.5.1 to Varbase 8.5.2
```
  Given that we are in the docroot of the current Varbase project
    And all files are updated using (copy and past) or (composer require/update
   When we run drush "updb" or go to "/update.php"
...
# Updating Varbase 8.5.0 to Varbase 8.5.1

## Updating files with *Copy and Paste* for Varbase 8.5.0 to Varbase 8.5.1
```
  Given that we are at the drupal root folder for varbase
   When we delete all drupal core folders and files
    And we copy all new Varbase files drupal root folder for varbase
...
```
   When we delete the "composer.lock" file
    ...
    And we delete the "docroot/profiles/varbase" folder
    And we delete the "docroot/libraries" folder
    And we run the "composer require vardot/varbase:8.5.1" command
    And wait for composer to finish work
   Then we should not see any issues in the terminal
    And we should see "Writing lock file" in the terminal
    And we should see "Generating autoload files" in the terminal
...
## Updating the active config and database from Varbase 8.5.0 to Varbase 8.5.1
```
  Given that we are in the docroot of the current Varbase project
    And all files are updated using (copy and past) or (composer require/update
   When we run drush "updb" or go to "/update.php"
   Then we should see the steps of updates.
   When we run drush "updb" or go to "/update.php" again
   Then we will have the site update with the new Varbase 8.5.1 version
   When we go to "/admin/config/development/features"
   Then we should see "Changed"
   When we follow with each feature to import new changes.
   Then we will have the Varbase site updated to the latest version.
