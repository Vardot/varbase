<div class="panel-varbase-right-sidebar clearfix panel-display" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  <div class="row">
    <?php if ($content['top']): ?>
      ...
      <div class="row">
        <div class="container">
          <div class="row">
            ...
            <div class="panel-region-right panel-panel <?php print $right_class; ?>">
              <div class="inside">
