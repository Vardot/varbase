...
projects[varbase_core][version] = 5.0-alpha3

projects[varbase_media][type] = module
projects[varbase_media][version] = 5.0-alpha5

projects[varbase_bootstrap_paragraphs][type] = module
projects[varbase_bootstrap_paragraphs][version] = 5.0-alpha3

projects[varbase_editor][type] = module
projects[varbase_editor][version] = 5.0-alpha3

projects[varbase_landing][type] = module
projects[varbase_landing][version] = 5.0-alpha3

projects[varbase_search][type] = module
projects[varbase_search][version] = 5.0-alpha2

projects[varbase_seo][type] = module
projects[varbase_seo][version] = 5.0-alpha3

projects[varbase_heroslider_media][type] = module
projects[varbase_heroslider_media][version] = 5.0-alpha3

projects[varbase_carousels][type] = module
projects[varbase_carousels][version] = 5.0-alpha2

projects[varbase_total_control][type] = module
projects[varbase_total_control][version] = 5.0-alpha2

projects[varbase_auth][type] = module
projects[varbase_auth][version] = 5.0-alpha2

projects[varbase_blog][type] = module
projects[varbase_blog][version] = 5.0-alpha3

projects[varbase_styleguide][type] = module
projects[varbase_styleguide][version] = 5.0-beta4
...
projects[vartheme][version] = 5.0-alpha2

projects[vartheme_material][type] = theme
projects[vartheme_material][version] = 5.0-alpha2

projects[vartheme_admin][type] = theme
projects[vartheme_admin][version] = 5.0-alpha2

projects[vartheme_material_admin][type] = theme
projects[vartheme_material_admin][version] = 5.0-alpha2
